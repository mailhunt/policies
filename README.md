...
If you try to click on any of the Support links in this repository, you'll get a 404 page. Don't despair! You can always reach us at support@mailhunt.com. Highrise customers can also email support@highrisehq.com and HEY users can reach out to support@hey.com. Your emails all go to our same [friendly Support team](https://mailhunt.com/support).
...
> Adapted from the [mailhunt open-source policies](https://github.com/mailhunt/policies) / [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)
...
> MyCorp policies are open source, licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). Adapted from the [mailhunt open-source policies](https://github.com/mailhunt/policies) / [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
